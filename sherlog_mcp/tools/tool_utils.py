"""Shared utilities for tool responses.

This module provides common utilities for converting DataFrames and other
results to standardized dict responses for MCP tools.
"""
